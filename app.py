# app.py
# O Robô de Análise (Versão 5.1 - Mais Ligas)
# UPGRADE: Adicionadas todas as ligas do plano gratuito
...
# --- ESTA É A MUDANÇA (DICIONÁRIO DE LIGAS) ---
LIGAS_DISPONIVEIS = {
    "Brasileirão": "BSA",
...
# --- ESTA É A MUDANÇA (DICIONÁRIO DE EMOJIS) ---
LIGAS_EMOJI = {
